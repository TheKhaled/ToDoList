...
import 'package:doit/Screens/OnBording.dart';
import 'package:flutter/material.dart';

class TheSplash extends StatefulWidget {
  @override
  _TheSplashState createState() => _TheSplashState();
}

class _TheSplashState extends State<TheSplash>
  ...
  void initState() {
    ...
    Future.delayed(Duration(seconds: 3), () {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
            builder: (context) => ONBording()), // Replace with your home screen
      );
    });
  }
